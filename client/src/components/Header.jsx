...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#00ffff] lg:px-20 lg:py-5 py-2 px-10 text-[#240d33] flex  flex-wrap lg:justify-between justify-center">
        ...
        <div className="flex flex-wrap items-center lg:gap-6 gap-x-4 gap-y-2 justify-center lg:text-md text-xs">
          <a href="mailto:info@srijvt.lk">info@srijvt.lk</a>
      ...
      <div className="lg:px-20 px-10 lg:py-5 py-1 flex justify-between items-center text-primary">
        <Link to="/" className="flex items-center gap-3">
          ...
          <h3 className="lg:text-4xl text-sm font-bold">SRI JVT <br/> Consultancy</h3>
        </Link>
